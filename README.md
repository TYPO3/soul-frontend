...
| [`<sds-eyebrow>`](https://typo3.github.io/soul-design-system/frontend/components/content.html#component-sds-eyebrow) | The line over a title, saying what kind of thing it opens — the label register as a block, carrying the title group's step itself. `label` |
