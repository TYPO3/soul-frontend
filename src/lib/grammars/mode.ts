/* What a highlight.js language definition is, as far as a grammar written
   here uses it. Declared rather than imported: the library types a mode
   against helpers and inherited modes this system never uses. The PHP port
   reads the same fields out of JSON. The names are the library's.
